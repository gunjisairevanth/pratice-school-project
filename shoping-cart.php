	...
	<div class="wrap-header-cart js-panel-cart">
		...
		<div class="header-cart flex-col-l p-l-65 p-r-25">
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				inner join cart on cart.p_id=products.product_id and cart.order_id is null;");
				$total_cart_value=0;
			...
			<div class="row">
				...
				echo '
					<tr class="table_row">
									...
									<td class="column-4">
									<input class="mtext-104 cl3 txt-center num-product" value="'.$product_qty.'" type="number" name="num-product2" value="1">
									</td>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								<p class="stext-111 cl6 p-t-2">
									<?php echo $address.'<br>'.$city.'<br>'.$country.'<br>'.$phone; ?>
								</p>
						...
						<form action="payment/pgRedirect.php" method="POST">
						<input value="<?php echo $id; ?>" name="CUST_ID" readonly style="opacity: 0;"></input>
						<input value="<?php echo $total_cart_value; ?>" name="TXN_AMOUNT" readonly style="opacity: 0;"></input>
